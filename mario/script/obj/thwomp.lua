...
function Thwomp:pretouch(other, side)
	-- go through things below us
	if side == 'down' then
	
		-- but, if we're going through it, still register its touch ( so we can still hit players)
