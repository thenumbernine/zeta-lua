{
	...
	{create="remove('geemer-right-wall', 'geemer-left-wall', 'boss-geemer') if session.geemerBossKilled then self.remove = true end",pos={163.5,117},spawn="zeta.script.obj.trigger",trigger="if session.geemerBossKilled then return end respawn 'geemer-left-wall' respawn 'geemer-right-wall' centerView{respawn 'boss-geemer'.pos:unpack()}"},
	...
	{pos={168.5,236},spawn="base.script.obj.start"},
