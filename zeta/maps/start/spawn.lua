{
	...
	{create="removeGeemersIfBossNotKilled()",name="remove all geemers before the boss is killed",pos={424.5,960},spawn="zeta.script.obj.trigger"},
	{create="removeGeemersIfBossNotKilled()",name="remove all geemers before the boss is killed",pos={434.5,1009},spawn="zeta.script.obj.trigger"},
	...
	{pos={438.5,1005},spawn="zeta.script.obj.terminal",text="Mining Operation"},
}